...
//            ));
    ...
    <li>
        ...
        <div class="sponsor_div">
            <a target="_blank" href="http://www.marblemobility.com/"><img style="padding-bottom: 10px;" width="100" src="<?php bloginfo('template_url'); ?>/images/cloudpact-marble-logo-small.png" alt="by CloudPact.com" /></a><br>
            Silver Sponsor
        </div>
<!--
        <div class="sponsor_div">
