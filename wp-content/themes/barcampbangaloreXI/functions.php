...
function theme_bcbYPipe($tag)
{
	...
	$request =  'http://pipes.yahoo.com/pipes/pipe.run?_id=d83efcace9733ec457913f7291a5c341&_render=php&results_c=8&tag='.$tag;
...
//				printf("<div><p><a href=\"%s\">%s</a></p>text<br/><p>%s</p>\n", $val['link'], $val['title'], $val['description']);
				...
				printf("<div><p> %s </p><a rel=\"nofollow\" href=\"%s\">Link</a></div><br/>\n", $val['description'], $val['link']);
			}
	    }
	}  
}
...
//print_r($wpdb);
	...
	if($rs==0){// not attending yet
		...
		<input type=\"image\" value=\"I want to attend\" src=\"";
		bloginfo('template_directory');
		echo "/images/iattend.gif\" style=\"padding-top:3px\" />
		...
		<input type=\"image\" value=\"I want to attend\" src=\"";
		bloginfo('template_directory');
		echo "/images/iattend.gif\" style=\"padding-top:3px\" DISABLED />

                Login to register for a session
		<!---  type=\"submit\" value=\"I want to attend\" --->";  
	...
	else //attending already
	{
		...
		echo "<span style='font-weight: bold;letter-spacing:-0.05em'>You are attending this</span>
		<input type=\"hidden\" name=\"natt\" value=\"$post_ID\" /><br />
		<!-- input type=\"submit\" value=\"No. I am not\"  -->
		<small><a href=\"?natt=$post_ID\"><img src=\"";
		bloginfo('template_directory');
		echo "/images/unattend.gif\"   border=\"0\"></a></small>";
	}
	echo "</form>";
...
echo('<div id="usattending">'); //to style the links
...
print " </td><td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
 ...
 //////////////////// jquery management from csstricks
 if( !is_admin()){
   wp_deregister_script('jquery');
   wp_register_script('jquery', ("http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"), false, '1.7.1');

   wp_register_script('lettering', 'images/jquery.lettering-0.6.1.min.js');
