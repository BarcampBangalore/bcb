...
<div id="archives_page_wrapper" class="centered_background">
    ...
    <div id="archives_page_content">
        ...
        <div class="container">
                ...
                <div id="archives_page_header" class="col-xs-12 single_page_box">
                    ...
                    <div id="archives_page_bcb_selector_buttons">
                        <ul id="archives_page_bcb_selector">
                            <li class="archive_selected"><a class="archives_current" data-contentdiv="archive_1458">BCB Monsoon 2015</a></li> 
            ...
            $archive_categories = array(1458 => "BCB Monsoon 2015", 1366 => 'bcbxah', 
            ...
            <div id="archive_<?php echo $archive_cat; ?>" class="archives_parent" >
                ...
                <div class="row">
                        ...
                        while (have_posts()) : the_post(); ?>
                            ...
                            <div class="sessions_page_card col-xs-12 col-sm-6 col-md-6 col-lg-4">
                                <div class="sessions_page_card_content container-fluid track_color_border_archive">
                                    <div class="row">
                                        ...
                                        <div class="sessions_page_card_right_column track_color_border_archive col-xs-10">
