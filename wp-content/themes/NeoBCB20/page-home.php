        ...
        <div id="homepage_ct1_r4">
            <div id="homepage_social_bar">
                <div class="visible-xs-inline-block">
                    <a href="whatsapp://send?text=Hey! Did you hear about Barcamp Bangalore? It's happening soon!. Checkout https://barcampbangalore.com for more info" data-action="share/whatsapp/share"><img src="<?php echo get_bloginfo('template_url') . '/images/whatsapp_icon-35.png' ?>" />   Share via Whatsapp</a>
                </div>
                <div>
...
<div id="homepage_cb3">
    ...
    <div id="homapage_ct3" class="container">
        ...
        <div id="homepage_how_to_register_description">
                 ...
                 Thank you for being part of Barcamp Bangalore. Registrations are now closed. The next edition of Barcamp Bangalore will be announced soon. Subscribe to our <a href="https://groups.yahoo.com/neo/groups/bangalore_barcamp/info">mailing list</a> or the <a href="https://www.meetup.com/Barcamp-Bangalore/">Meetup group</a> to know when.
...
<div id="homepage_cb6">
    <div id="homepage_ct6" class="container">
        ...
        <div id="homepage_sponsors_description row">
            ...
            Interested in being featured here? Checkout our <a href="https://barcampbangalore.com/staging/wp-content/themes/NeoBCB20/docs/bcb-sponsorship.pdf">Sponsorship document</a> to find out the details.
            </div>
        </div>
         <!--
