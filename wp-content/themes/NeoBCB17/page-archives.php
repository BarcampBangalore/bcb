    ...
    <div id="sessionpage_content">
        ...
        <div id="sessionpage_midsection">
            <div id="generalpage_posttext">
                <ul id="archivelinks">
                    <li class="archive_selected"><a data-contentdiv="archive_bcb15">BCB15</a></li>
        ...
        $archive_categories = array(931 => 'bcb15', 785 => 'bcb14', 636 => 'bcb13', 479 => 'bcb12', 399 => 'bcb11', 324 => 'bcb10', 220 => 'bcb9', 3 => 'bcb8' );
        foreach ($archive_categories as $archive_cat => $archive_catname):
            ?>
        <div id="archive_<?php echo $archive_catname; ?>" class="archive_parent" <?php if ($archive_catname != "bcb15")  echo 'style="display: none;"';  ?> >
